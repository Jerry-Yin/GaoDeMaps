...
import com.example.yin.gaodetestdemo01.util.LocationUtil;
...
//    private LatLonPoint lp = new LatLonPoint(39.993167, 116.473274);//北京经纬度
    private LatLonPoint lp = new LatLonPoint(30.3202, 120.3502);//杭州(120.2E ,30.3N)
//    private LatLonPoint lp;//自定义工具类获取当前经纬度, 记得在 Destroy() 方法中取消位置监听器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_around_search);
...
//            LocationUtil.getLocation(AroundSearchActivity.this);
////            Location location= LocationUtil.returnLocation();
...
//				startActivity(intent);
    ...
    protected void onDestroy() {
        super.onDestroy();
        LocationUtil.onDestroyMethod(AroundSearchActivity.this);
        mMapView.onDestroy();
    }
